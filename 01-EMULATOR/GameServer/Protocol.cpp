...
void GCAnsCsAccessCrownState(int aIndex,BYTE state)
{
	...
	switch (state)
	{
		case 0:
		{
			...
			LogAdd(LOG_BLACK,"[ Register Attempt ] Accumulated Crown Access Time : %d - Guild:%s - Player [%s][%s]",lpObj->AccumulatedCrownAccessTime,lpObj->GuildName,lpObj->Account,lpObj->Name);
		}
		break;
		case 1:
		{
			...
			LogAdd(LOG_BLACK,"[ Register Success ] Accumulated Crown Access Time : %d - Guild:%s - Player [%s][%s]",lpObj->AccumulatedCrownAccessTime,lpObj->GuildName,lpObj->Account,lpObj->Name);
		}
		break;
		case 2:
		{
			...
			LogAdd(LOG_BLACK,"[ Register Fail ] Accumulated Crown Access Time : %d - Guild:%s - Player [%s][%s]",lpObj->AccumulatedCrownAccessTime,lpObj->GuildName,lpObj->Account,lpObj->Name);
		}
		break;
	}

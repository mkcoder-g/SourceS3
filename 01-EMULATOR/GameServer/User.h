...
static const int gGameServerMaxAccount = MAX_OBJECT_USER;
...
struct OBJECTSTRUCT
{
	...
	struct CUSTOM_PICK_LIST* CustomPickList;
	DWORD CustomPickItemList[100];
	DWORD CustomPickItemLevel[100];
	DWORD CustomPickItemListCount;
	int CustomPickSwitch;
	int CustomPickZen;
	int CustomPickJewel;
	int CustomPickExc;
	int CustomPickSet;
	DWORD CustomPickMaxTime;
	WORD BCCount;
	WORD CCCount;
	WORD DSCount;
	WORD DGCount;
...
void gObjCoinAdd(int aIndex,int Coin1);
void gObjCoinSub(int aIndex,int Coin1);
//**************************************************************************//

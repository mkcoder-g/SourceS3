...
void GCItemGetRecv(PMSG_ITEM_GET_RECV* lpMsg)
{
	...
	{
		*(DWORD*)0x0795D638 = lpMsg->ViewIndex;
	}
}
...
{
	if(lpMsg->response == 1 && *(DWORD*)0x07EB5058 == 110)
	{
		*(DWORD*)0x07EB5058 = 0;
	}
}
...
void GCCharacterInfoRecv(PMSG_CHARACTER_INFO_RECV* lpMsg) // OK
{
	...
	*(WORD*)(*(DWORD*)(MAIN_VIEWPORT_STRUCT)+0x22C) = 0;

	*(BYTE*)(*(DWORD*)(MAIN_VIEWPORT_STRUCT)) = 0;

	STRUCT_DECRYPT

	SetByte(0x005243E0,gProtect.m_MainInfo.AttackAnimationValue[((*(BYTE*)(*(DWORD*)(MAIN_CHARACTER_STRUCT)+0x0B)) & 7)]);
...
void GCNewMessageRecv(PMSG_NEW_MESSAGE_RECV* lpMsg) // OK
{
	if(lpMsg->type == 0)
	{
		*(DWORD*)0x07EB5058 = 138;

		((int(*)(char*))0x006CAFE0)(lpMsg->message);
	}
	else
	{
		((void*(*)(char*,char*,int))0x005A0D60)("",lpMsg->message,lpMsg->color);
	}
}
	...
	if(gPacketManager.AddData(lpMsg,size) != 0 && gPacketManager.ExtractPacket(EncBuff) != 0)
	{
		...
		if(EncBuff[0] == 0xC3 || EncBuff[0] == 0xC4)
		{
			if(EncBuff[0] == 0xC3)
			{
				...
				((void(__thiscall*)(void*,int))0x00403F30)((void*)0x05875968,MAIN_PACKET_SERIAL);

				EncBuff[1] = (*(BYTE*)(MAIN_PACKET_SERIAL))++;

				((void(__thiscall*)(void*,int))0x004040A0)((void*)0x05875968,MAIN_PACKET_SERIAL);

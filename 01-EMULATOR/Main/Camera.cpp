...
CCamera::CCamera() // OK
{
	...
	this->m_Address.Zoom = (float*)0x006CE250;

	this->m_Address.RotX = (float*)0x07EB16A0;

	this->m_Address.RotY = (float*)0x007B3918;

	this->m_Address.PosZ = (float*)0x007B1720;

	this->m_Address.ClipX[0] = (float*)0x007B382C;

	this->m_Address.ClipX[1] = (float*)0x007B3838;

	this->m_Address.ClipY[0] = (float*)0x006754EE;

	this->m_Address.ClipY[1] = (float*)0x00675363;

	this->m_Address.ClipGL = (float*)0x007B33CC;

	this->m_Default.IsLoad = 0;

	SetCompleteHook(0xE9,0x006B7BF2,&RotateDamageAngle);
}
...
{
	static DWORD RotateDamageAngleAddress1 = 0x006B7B14;
